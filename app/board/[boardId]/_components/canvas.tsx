...
export const Canvas = ({ boardId }: CanvasProps) => {
    ...
    }, [canvasState, camera, startMultipleSelection, updateSelectionNet, resizeSelectedLayer, translateSelectedLayers, continueDrawing])
    ...
    const onPointerUp = useMutation((
        ...
        history.resume()
    }, [setCanvasState, camera, canvasState, history, insertLayer, insertPath, unselectLayers])
